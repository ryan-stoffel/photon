...
- **Applications** — fuzzy search over `/Applications`, `/System/Applications`, `~/Applications`, and System Settings panes, ranked by frecency. Photon hides first, then brings the launched app above everything. Photon hides first, then brings the launched app above everything.
